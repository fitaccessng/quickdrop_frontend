    ...
    <div className="bg-[#f5f6f7] font-body text-slate-900 min-h-screen pb-24 antialiased">
      <div className="relative h-72 w-full overflow-hidden bg-white">
        ...
        <div className="relative z-10 flex flex-col items-center">
          ...
          <h1 className="mt-3 text-xl font-black tracking-tight text-slate-800">{user?.full_name}</h1>
          <p className="text-[10px] font-black text-slate-400 uppercase tracking-[0.2em]">Customer Account</p>
        </div>
      </div>
      ...
      <div className="px-6 -mt-10 relative z-20">
        <div className="bg-white/70 backdrop-blur-2xl rounded-[2.5rem] p-6 shadow-xl shadow-slate-200/40 border border-white flex justify-around">
          <div className="text-center">
            <p className="text-lg font-black text-slate-800 tracking-tighter">{profileStats.orders}</p>
          ...
          <div className="text-center">
            <p className="text-lg font-black text-[#ff9300] tracking-tighter">{profileStats.rating}</p>
            <p className="text-[9px] font-black uppercase text-slate-400 tracking-widest">Rating</p>
          </div>
          <div className="w-px h-8 bg-slate-100 self-center" />
          <div className="text-center">
            <p className="text-lg font-black text-slate-800 tracking-tighter">{profileStats.points}</p>
